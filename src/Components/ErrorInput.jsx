  ...
  return (
    <div className='bg-(--primary-color) border border-(--outline) w-full h-[22vh] px-2 sm:px-3 md:px-4 py-2 sm:py-3 md:py-4 mt-1 text-sm md:text-base'>
        <div>
            ...
            type="text" placeholder="Paste your error here..." className='border border-(--outline) outline-0 bg-(--bg-color) text-(--text-color) placeholder:text-(--text-color) px-2 md:px-3 py-1.5 md:py-2 w-full rounded-sm text-lg'/>
        </div>
